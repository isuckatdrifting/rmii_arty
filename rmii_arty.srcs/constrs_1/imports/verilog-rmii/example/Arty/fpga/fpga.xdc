...
#create_clock -period 40.000 -waveform {0 18} -name rmii2mac_rx_clk [get_pins u_mii_to_rmii/rmii2mac_rx_clk]
#create_clock -period 40.000 -waveform {0 18} -name rmii2mac_tx_clk [get_pins u_mii_to_rmii/rmii2mac_tx_clk]
